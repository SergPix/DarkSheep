...
//  
//
//  Created by Serg Kolodny on 25.05.2022.


import UIKit
import RealmSwift

class AddNewPlayer: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.tableView.delaysContentTouches = false // remove the delay in gesture processing to restore the normal operation of the button animation
    }
    ...
    @IBAction func viewPresentationAgain(_ sender: UIButton) {
        
        if let wayToPresentation = storyboard?.instantiateViewController(withIdentifier: "pageView-id") as? PageView {
